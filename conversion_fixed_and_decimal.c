...
char binary_number[] = "11111111111111111111111111111111"; 
...
int menu()
{
    ...
    {
        printf("Menu: \n");
        printf("1. Conversion decimal to fixed point 32b. \n");
        printf("2. Conversion fixed point 32b to decimal. \n");
        printf("3. Exit \n");
...
void conversions(int option)
{
    ...
    {   
        ...
        fixed_number_1 = abs(round(decimal_number * (1 << 15))); // entire number
        //fixed_number_1 = round(decimal_number * (1 << 15)); // entire number
    ...
    else if (option == 2) // fixed point to decimal
    {
        ...
        while( count > 0 )
        {
            ...
            {
                fixed_number_2 = fixed_number_2 + (1 << 31-count);
            }
            count--;
        }

        decimal_number = (double)fixed_number_2 / (double)(1 << 15);
